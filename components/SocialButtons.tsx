...
const SocialButtons : React.FC<{}> = () => {
    return <div className="text-md flex flex-row justify-center items-center gap-5">
        ...
        <SocialIcon network="email" bgColor="red" url="mailto:marcelohenrique7x@gmail.com" /> 
        <SocialIcon network="instagram" bgColor="#FE3264" url="https://www.instagram.com/marcelo7x" /> 
